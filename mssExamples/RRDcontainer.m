...
% [xdot,U] = RRDcontainer(x,ui) returns the speed U in m/s (optionally) and the 
% time derivative of the state vector: x = [ u v r x y psi p phi delta n xw1 xw2]'  for
% a container ship L = 175 m (similar as container.m except that wave disturbances in roll are 
% added and that Ddelta_max = 20 instead of 5), where
%
