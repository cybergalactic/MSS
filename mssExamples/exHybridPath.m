% exHybridPath is compatible with MATLAB and GNU Octave (www.octave.org).
% The function calculates a hybrid continuous path based on specified
...
% Revised:       
%   2024-06-12 : Added compatibility to GNU Octave. 
