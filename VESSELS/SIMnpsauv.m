...
f = figure('Position', [400, 400, 400, 200], 'Name', 'Control Method', 'MenuBar', 'none', 'NumberTitle', 'off', 'WindowStyle', 'modal');

% Add button group for control methods
bg1 = uibuttongroup('Parent', f, 'Position', [0.02 0.6 0.96 0.5], 'Title', 'Control Methods','FontSize',14,'FontWeight','bold');
radio1 = uicontrol(bg1, 'Style', 'radiobutton', 'FontSize',13, 'String', 'PID pole-placement control', 'Position', [10 40 500 30], 'Tag', '1');
radio2 = uicontrol(bg1, 'Style', 'radiobutton', 'FontSize',13, 'String', 'ALOS guidance law for 3-D path following', 'Position', [10 10 500 30], 'Tag', '2');
...
disp('-------------------------------------------------------------');
disp('MSS toolbox: NPS AUV (Length = 5.3 m)');
disp(' ')
if (ControlFlag == 1)
