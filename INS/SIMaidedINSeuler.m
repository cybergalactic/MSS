...
if isoctave()  % Octave command line inputs
    ...
    disp('Attitude Aiding:');
    disp('  1. Compass');
    disp('  2. Attitude and heading reference system (AHRS)');
    ...
    uicontrol(bg1, 'Style', 'radiobutton', 'FontSize',13, 'String', 'Attitude and heading reference system (AHRS)', 'Position', [10 10 500 30], 'Tag', '2');
